...
def get_press_time(distance, screen_rate=1.2):
    """
    :param distance: dist between two centre point of platforms
    :param screen_rate: due to the size of different screens, this need change by hand
    :return:
    """
    press_time = int(distance * screen_rate)
...
class wechatJump(QtCore.QObject):
    ...
    def main(self, w_length, h_length, sig):
        ...
        for i in range(10000):
            ...
            if self.Eye.game_over(img_rgb): break
            ...
            sig.emit(press_time)
            dobot.play_1_loop(press_time, dobot_state)
